                        ...
                        <div class="x_content">
                            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                <div class="profile_img">
                                    <div id="crop-avatar">
                                        <!-- Current avatar -->
                                        <img class="img-responsive avatar-view" src="http://lorempixel.com/128/128"
                                ...
                                <ul class="list-unstyled user_data">
                                    <li>
                                        ...
                                        <a href="mailto:{{$admin->email}}" role="link"> {{ $admin->email }}</a>
                                    </li>
                                ...
                                <a href="{{ route('admin.delete', ['id'=>$admin->id]) }}" class="btn btn-danger"
                                   role="link">
                                    <i class="fa fa-trash m-right-xs"></i> Delete Profile
                                </a>
                                <a href="{{ route('admin.edit.admin', ['id'=>$admin->id]) }}" class="btn btn-success"
                                   role="link">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                                            ...
                                            <ul class="messages">
                                                <li>
                                                    <img src="https://loremflickr.com/64/64" class="avatar"
                                                         alt="Avatar">
