              ...
              <div class="title_right">
                ...
                <form action="{{ route('admin.search') }}" method="get" role="form">
                  <div class="input-group">
                    <input type="search" name="search" id="txt_search" class="form-control" placeholder="Search for name">
                        ...
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            ...
                            <div class="right col-xs-5 text-center">
                              <img src="http://lorempixel.com/128/128/" alt="{{ $value->name }}" class="img-circle img-responsive">
                            </div>
                          </div>
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis">
                              ...
                              <a href="{{ route('admin.show', ['id'=>$value->id]) }}" class="btn btn-primary btn-xs" role="link">
